        ...
        <Row className="g-5">
          <Col md={4} sm={6} xs={12}>
            ...
            <div className="footer-first-text">
              <p>
                <span className="orange-color fw-bold fs-5">
                  Computer Mania
                </span>
                Is An Online Review Platform Which Will Give You The Suggestion
                Of Best Computer That Suit Your Choice & Budget.
              </p>
            </div>
          ...
          <Col md={4} sm={6} xs={12}>
            ...
            <div className="footer-second-side">
              <p>
                <span className="orange-color fw-bold">Computer Mania</span>
                <span className="d-block">
                  {" "}
                  BD Shop: 740 Level: 7, Lift -7 Suvastu Arcade ( ICT Bhaban)
                </span>
                <span className="d-block">
